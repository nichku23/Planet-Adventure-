...
while play_again == 'yes':      
    ...
    if first_planet.lower() == 'jupiter':
        ...
        if collect_or_fly == 'collect':
            ...
            print(f"\nAh yes, my nothing gives the ship quite a cleaning like mushballs from Jupiter! Do you see how the surface shines? \nFantastic! Thank you for your help, {name}!")
        else:
    ...
    if first_planet.lower() == 'neptune':
        ...
        print("\n(Z takes the ship down into the clouds. White a bright, beautiful blue color you see all around you. \nSuddenly ice starts to cover the ship and you can no longer see outside.)")
